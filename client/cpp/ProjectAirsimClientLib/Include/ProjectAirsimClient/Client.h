...
class Client {
 ...
 public:
  ...
  ASC_DECL Status Publish(const char* sz_topic_name,
  ...
  ASC_DECL Status SetInteractiveFeature(const std::string& str_feature_name,
                                        bool f_enable,
                                        bool* pf_enabled_out);
  ASC_DECL Status GetBuildCommitHash(std::string* pstr_hash_out);
