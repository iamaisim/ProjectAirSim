...
Demonstrates flying a quadrotor with Simulink physics and Simulink controller.
...
if __name__ == "__main__":
    scene_to_run = "scene_quadrotor_matlab_combined.jsonc"
    simulink_model_name = "matlab_combined_demo_model"
