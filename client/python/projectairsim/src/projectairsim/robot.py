...
class Robot(object):
    ...
    def log_topics(self):
        """Logs a human-readable list of all topics associated with the robot"""
    ...
    def set_pose(self, pose: Pose, reset_kinematics=True) -> bool:
        """Sets Pose for a non-physics vehicle
    ...
    def set_geo_pose(
        ...
        """Sets the pose of a vehicle using latitude, longitude, and altitude
    ...
    def get_ground_truth_pose(self) -> Pose:
        """Gets Pose for vehicle

        Returns:
            Pose: the vehicle pose
        """
    ...
    def get_ground_truth_geo_location(self) -> Dict:
        """Gets the geo location of the vehicle

        Returns:
            Dict: the vehicle's geo location, as a dict with keys "latitude", "longitude", and "altitude"
        """
    ...
    def get_estimated_geo_location(self) -> Dict:
        """Gets the estimated geo location of the vehicle

        Returns:
            Dict: the vehicle's geo location from the vehicle's state estimator, as a dict with keys "latitude", "longitude", and "altitude"
        """
        get_geo_location_req = {
    ...
    def get_estimated_kinematics(self) -> Dict:
        """Get estimated kinematics from the vehicle's state estimator
    ...
    def set_camera_pose(
        ...
        """Sets the relative pose of a vehicle camera
    ...
    def set_focal_length(
        ...
        """Sets the focal length of a vehicle camera, affecting the image 'zoom'
    ...
    def set_field_of_view(
        ...
        """Sets the field of view of a vehicle camera
    ...
    def reset_camera_pose(
        ...
        """Reset camera pose on vehicle to config setting
    ...
    def set_external_force(self, ext_force: List[float]) -> bool:
        """
        Set arbitrary external force on a vehicle, which can be used
