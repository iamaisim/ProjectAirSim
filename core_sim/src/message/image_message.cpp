...
class ImageMessage::Impl : public MessageImpl {
 public:
  ...
  Impl(TimeNano time_stamp_val, uint32_t height_val, uint32_t width_val,
       ...
       std::vector<uint8_t>&& data_val, float pos_x_val, float pos_y_val,
       float pos_z_val, float rot_w_val, float rot_x_val, float rot_y_val,
       float rot_z_val,
...
ImageMessage::ImageMessage(TimeNano time_stamp_val, uint32_t height_val,
                           ...
                           std::vector<uint8_t>&& data_val, float pos_x_val,
    ...
    : Message(std::make_shared<ImageMessage::Impl>(
          ...
          step_val, std::move(data_val), pos_x_val, pos_y_val, pos_z_val,
          rot_w_val, rot_x_val, rot_y_val, rot_z_val, annotations)) {}
