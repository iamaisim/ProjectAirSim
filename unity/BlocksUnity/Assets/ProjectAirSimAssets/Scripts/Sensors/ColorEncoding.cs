...
public class ColorEncoding
{
    ...
    public static Color EncodeIDAsColor(int instanceId)
    {
        ...
        // Debug.Log(uid + " >>> " + System.Convert.ToString(sid, 2).PadLeft(24,
        // '0'));
    ...
    public static Color EncodeLayerAsColor(int layer)
    {
        ...
        new Color(1, 1, z, 1), new Color(1, z, 1, 1),
        new Color(z, 1, 1, 1),  //
        new Color(1, z, 0, 1), new Color(z, 0, 1, 1),
        new Color(0, 1, z, 1),  // 7

        new Color(1, 0, 0, 1), new Color(0, 1, 0, 1),
        new Color(0, 0, 1, 1),  // 8
        new Color(1, 1, 0, 1), new Color(1, 0, 1, 1),
        new Color(0, 1, 1, 1),                        //
