    ...
    public ProjectAirSim(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            List<string> liststrIncludes = new List<string> {
                    ...
                    PluginDirectory + "/SimLibs/generic_vehicle_api/include",
        ...
        if (Target.Platform == UnrealTargetPlatform.Win64)
        {
            List<string> liststrLibraries = new List<string> {
                    ...
                    PluginDirectory + "/SimLibs/generic_vehicle_api/" + buildType + "/generic_vehicle_api.lib",
        ...
        else
        {
            List<string> liststrLibraries = new List<string> {
                    ...
                    PluginDirectory + "/SimLibs/generic_vehicle_api/" + buildType + "/libgeneric_vehicle_api.a",
