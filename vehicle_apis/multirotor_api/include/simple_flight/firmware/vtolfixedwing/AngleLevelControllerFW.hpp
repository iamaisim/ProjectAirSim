...
#ifndef MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_ANGLELEVELCONTROLLERFW_HPP_
#define MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_ANGLELEVELCONTROLLERFW_HPP_
...
#include "AngleRateControllerFW.hpp"

namespace simple_flight {

// Same as AngleLevelController except all PID parameters are used
class AngleLevelControllerFW : public IAxisController,
                               public IGoal  // for internal rate controller
{
 public:
  AngleLevelControllerFW(Params* params, const IBoardClock* clock = nullptr)
  ...
  void Initialize(unsigned int axis, const IGoal* goal,
    ...
    rate_controller_.reset(new AngleRateControllerFW(params_, clock_));
 ...
 private:
  ...
  std::unique_ptr<AngleRateControllerFW> rate_controller_;
};

}  // namespace simple_flight

#endif  // MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_ANGLELEVELCONTROLLERFW_HPP_