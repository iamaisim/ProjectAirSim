...
#ifndef MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_FWYTORQUECONTROLLER_HPP_
#define MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_FWYTORQUECONTROLLER_HPP_
...
#include "PositionControllerFWZH.hpp"
#include "VelocityControllerFW.hpp"
#include "VelocityControllerFWZH.hpp"

namespace simple_flight {

// Y-axis torque controller for fixed-wing flight
class FWYTorqueController : public IAxisController, private IGoal {
 public:
  FWYTorqueController(Params* params, const IBoardClock* clock = nullptr)
      : axis_controllers_(),
        clock_(clock),
  ...
  IFWAngleController* GetZHeightController(const GoalMode& goal_mode) {
    switch (goal_mode[IAxisController::kZHeight]) {
      ...
      case GoalModeType::kVelocityWorld:
        return (new VelocityControllerFWZH(params_, clock_));
    }
  }
...
#endif  // MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_FWYTORQUECONTROLLER_HPP_