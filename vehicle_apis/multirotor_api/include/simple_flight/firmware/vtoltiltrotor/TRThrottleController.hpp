...
#ifndef MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_TRTHROTTLECONTROLLER_HPP_
#define MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_TRTHROTTLECONTROLLER_HPP_
...
class TRThrottleController : public IAxisController {
 public:
  TRThrottleController(Params* params, const IBoardClock* clock = nullptr)
...
#endif  // MULTIROTOR_API_SIMPLE_FLIGHT_FIRMWARE_TRTHROTTLECONTROLLER_HPP_